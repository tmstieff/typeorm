        ...
        if (this.embeddedMetadata) {
            ...
            if (embeddedObject) {
                if (this.relationMetadata && this.referencedColumn) {
                    ...
                    if (relatedEntity && relatedEntity instanceof Object) {
                        return this.referencedColumn.getEntityValue(PromiseUtils_1.PromiseUtils.extractValue(relatedEntity));
                    }
                    else if (embeddedObject[this.propertyName] && embeddedObject[this.propertyName] instanceof Object) {
                        return this.referencedColumn.getEntityValue(PromiseUtils_1.PromiseUtils.extractValue(embeddedObject[this.propertyName]));
                    }
                }
                else if (this.referencedColumn) {
                    return this.referencedColumn.getEntityValue(PromiseUtils_1.PromiseUtils.extractValue(embeddedObject[this.propertyName]));
                }
                return PromiseUtils_1.PromiseUtils.extractValue(embeddedObject[this.propertyName]);
            }
            return undefined;
        }
        else {
            if (this.relationMetadata && this.referencedColumn) {
                ...
                if (relatedEntity && relatedEntity instanceof Object && !(relatedEntity instanceof Function)) {
                    ...
                    return this.referencedColumn.getEntityValue(PromiseUtils_1.PromiseUtils.extractValue(entity[this.propertyName]));
                }
            }
            else if (this.referencedColumn) {
                return this.referencedColumn.getEntityValue(PromiseUtils_1.PromiseUtils.extractValue(entity[this.propertyName]));
