...
var EntityMetadata = /** @class */ (function () {
    ...
    EntityMetadata.prototype.create = function () {
        ...
        var newObject = {};
        this.lazyRelations.forEach(function (relation) { return _this.connection.relationLoader.enableLazyLoad(relation, newObject); });
        return newObject;
    };
    /**
     ...
     */
    EntityMetadata.getValueMap = function (entity, columns) {
        var map = columns.reduce(function (map, column) {
