...
var ManyToManySubjectBuilder = /** @class */ (function () {
    ...
    ManyToManySubjectBuilder.prototype.buildForSubjectRelation = function (subject, relation) {
        ...
        var changedInverseEntityRelationIds = relatedEntities
            .map(function (relatedEntity) { return relation.inverseEntityMetadata.getEntityIdMap(relatedEntity); })
            .filter(function (relatedEntityRelationIdMap) { return relatedEntityRelationIdMap !== undefined && relatedEntityRelationIdMap !== null; });
