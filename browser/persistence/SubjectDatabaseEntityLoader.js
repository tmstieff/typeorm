                                ...
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        subjectGroup.subjects.forEach(function (subject) {
                                            ...
                                            if (!subject.metadata.hasAllPrimaryKeys(subject.entity))
                                                return;
                                        ...
                                        if (operationType === "save") {
                                            subjectGroup.subjects.forEach(function (subject) {
                                                ...
                                                subject.metadata.relations
                                                    .filter(function (relation) { return relation.getEntityValue(subject.entity) !== undefined; })
                                                    .map(function (relation) { return relation.propertyPath; })
