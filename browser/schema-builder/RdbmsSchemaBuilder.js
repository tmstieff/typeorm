...
var RdbmsSchemaBuilder = /** @class */ (function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        table = new Table(metadata.tableName, this.metadataColumnsToTableColumns(metadata.columns), true, metadata.engine, metadata.database, metadata.schema);
    ...
    RdbmsSchemaBuilder.prototype.dropRemovedColumns = function () {
        var _this = this;
        return PromiseUtils.runInSequence(this.entityToSyncMetadatas, function (metadata) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        newAndOldTableColumns = updatedTableColumns.map(function (changedTableColumn) {
                            ...
                            var newTableColumn = TableColumn.create(columnMetadata, _this.connection.driver.normalizeType(columnMetadata), _this.connection.driver.normalizeDefault(columnMetadata), _this.connection.driver.getColumnLength(columnMetadata));
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        addedKeys = metadataPrimaryColumns
                            ...
                            .map(function (primaryKey) { return new TablePrimaryKey("", primaryKey.databaseName); });
                    ...
                    case 1:
                        ...
                        addQueries = metadata.indices
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        tableIndex = TableIndex.create(indexMetadata);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        tableForeignKeys = dependForeignKeyInTable.map(function (foreignKeyMetadata) { return TableForeignKey.create(foreignKeyMetadata); });
    ...
    RdbmsSchemaBuilder.prototype.metadataColumnsToTableColumns = function (columns) {
        ...
        return columns.map(function (columnMetadata) {
            return TableColumn.create(columnMetadata, _this.connection.driver.normalizeType(columnMetadata), _this.connection.driver.normalizeDefault(columnMetadata), _this.connection.driver.getColumnLength(columnMetadata));
        });
    };
