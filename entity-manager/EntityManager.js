...
var EntityManager = /** @class */ (function () {
    ...
    EntityManager.prototype.create = function (entityClass, plainObjectOrObjects) {
        ...
        var mergeIntoEntity = metadata.create();
    ...
    EntityManager.prototype.findOne = function (entityClass, idOrOptionsOrConditions, maybeOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var metadata, alias, qb;
            return __generator(this, function (_a) {
                metadata = this.connection.getMetadata(entityClass);
                alias = metadata.name;
                if (FindOptionsUtils_1.FindOptionsUtils.isFindOneOptions(idOrOptionsOrConditions) && idOrOptionsOrConditions.join) {
                ...
                FindOptionsUtils_1.FindOptionsUtils.joinEagerRelations(qb, qb.alias, metadata);
                if (maybeOptions) {
                    FindOptionsUtils_1.FindOptionsUtils.applyOptionsToQueryBuilder(qb, maybeOptions);
                }
                if (FindOptionsUtils_1.FindOptionsUtils.isFindOneOptions(idOrOptionsOrConditions)) {
                    FindOptionsUtils_1.FindOptionsUtils.applyOptionsToQueryBuilder(qb, idOrOptionsOrConditions);
                }
                else if (idOrOptionsOrConditions instanceof Object) {
                    qb.where(idOrOptionsOrConditions);
                }
