...
var CannotAttachTreeChildrenEntityError = /** @class */ (function (_super) {
    ...
    function CannotAttachTreeChildrenEntityError(entityName) {
        var _this = _super.call(this, "Cannot attach entity \"" + entityName + "\" to its parent. Please make sure parent is saved in the database before saving children nodes.") || this;
